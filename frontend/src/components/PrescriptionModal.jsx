                ...
                <div className="relative z-10 px-6 lg:px-12 py-6 flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-0.5">
                                    ...
                                    <span className="text-[9px] font-black text-brand-teal uppercase tracking-[0.3em]">Precision Diagnostics</span>
                                </div>
                                <h2 className="text-2xl lg:text-3xl font-black font-display text-white tracking-tight leading-none">
                                    {isEditing ? 'Clinical Record Refinement' : 'Prescribe Interaction'}
                                </h2>
                                <div className="flex items-center gap-3 mt-1.5">
                                    ...
                                    {appointment.patientId?.medicalRecordNumber ? (
                    ...
                    <div className="hidden lg:flex items-center gap-4">
                        <div className="text-right mr-4">
                            <p className="text-[9px] font-black text-white/30 uppercase tracking-widest">Consultation Status</p>
                            <p className="text-xs font-bold text-brand-teal">Live Clinical Session</p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                        ...
                        <section className="space-y-6">
                            ...
                            <textarea
                                ...
                                className="input min-h-[140px] rounded-[1.5rem] bg-slate-50/50 border-2 border-slate-100 focus:bg-white transition-all p-6 text-lg font-medium"
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                                            ...
                                            <div className="md:col-span-12 lg:col-span-5 space-y-2">
                                                ...
                                                <div className="flex items-center bg-slate-50 border border-slate-100 rounded-[1.25rem] h-[58px] overflow-hidden focus-within:bg-white focus-within:border-brand-teal transition-all">
                                                    <input type="number" value={med.dosageValue} onChange={(e) => handleMedicineChange(index, 'dosageValue', e.target.value)} placeholder="Qty" className="flex-[1.5] min-w-0 bg-transparent px-5 text-xl font-black outline-none" required />
                                                    <div className="w-px h-8 bg-slate-200/50" />
                                                    <select value={med.dosageUnit} onChange={(e) => handleMedicineChange(index, 'dosageUnit', e.target.value)} className="flex-1 min-w-0 bg-transparent text-[10px] font-black uppercase tracking-[0.1em] outline-none text-center cursor-pointer" required>
                                            ...
                                            <div className="md:col-span-6 space-y-2">
                                                ...
                                                <div className="relative">
                                                    <input type="text" value={med.frequency} onChange={(e) => handleMedicineChange(index, 'frequency', e.target.value)} placeholder="e.g. 1-0-1" className="input bg-slate-50 border-slate-100 !h-[58px] pl-11 font-bold" required />
                                            ...
                                            <div className="md:col-span-6 space-y-2">
                                                ...
                                                <div className="flex items-center bg-slate-50 border border-slate-100 rounded-[1.25rem] h-[58px] overflow-hidden focus-within:bg-white focus-within:border-brand-teal transition-all">
                                                    <input type="number" value={med.durationValue} onChange={(e) => handleMedicineChange(index, 'durationValue', e.target.value)} placeholder="Val" className="flex-[1.5] min-w-0 bg-transparent px-5 text-xl font-black outline-none" required />
                                                    <div className="w-px h-8 bg-slate-200/50" />
                                                    <select value={med.durationUnit} onChange={(e) => handleMedicineChange(index, 'durationUnit', e.target.value)} className="flex-1 min-w-0 bg-transparent text-[10px] font-black uppercase tracking-[0.1em] outline-none text-center cursor-pointer" required>
            ...
            <div className="shrink-0 p-8 lg:px-12 bg-white border-t border-slate-100 flex items-center justify-between shadow-[0_-10px_40px_rgba(0,0,0,0.03)] z-50">
                <div className="hidden md:flex items-center gap-6">
                    ...
                    <p className="text-[10px] font-bold text-slate-400 max-w-[200px]">
                        Finalizing this prescription will formally close this clinical encounter.
                    </p>
                </div>
                    ...
                    >
                        {loading ? (
                            ...
                            <>
                                ...
                                <span>{isEditing ? 'COMMIT TO SYSTEM' : 'AUTHORIZE & ISSUE'}</span>
                            </>
                        )}
                    </button>
                </div>
